...
**Repository GitHub :** https://github.com/Florddev/5IW_securite-web

### Screenshots

1. **CI Pipeline passing:**
![CI Pipeline passing](imgs/ci-pipeline-passing.png)

2. **CD Pipeline passing:**
![CD Pipeline passing](imgs/cd-pipeline-passing.png)

3. **Docker Hub image:**
![Docker Hub image](imgs/docker-hub-image.png)
    ...
    steps:
      ...
      - name: build and push
        ...
        with:
          ...
          file: Dockerfile
          push: true
          tags: ${{ secrets.DOCKER_USERNAME }}/python-calculator:latest
```
